...
export const CAREER_PATHS: CareerPath[] = [
  {
    ...
    questions: [
      ...
      },
      {
        id: "fs5",
        topic: "REST APIs",
        question: "Which HTTP method is idempotent and replaces a full resource?",
      ...
      },
      {
        id: "fs6",
        topic: "SQL Indexing",
        question: "Why can an index speed up a WHERE lookup?",
        options: [
          "It caches the whole table in RAM",
          "It avoids a full table scan via a sorted structure",
          "It compresses the rows",
      ...
      },
      {
        id: "fs7",
        topic: "Docker",
        question: "What does `docker build` produce?",
        options: ["A container", "An image", "A volume", "A network"],
        answer: 1,
      },
      {
        id: "fs8",
        ...
        options: [
          ...
          "The first rejection it encounters",
          "Always undefined",
          "A timeout error",
        ],
        answer: 1,
      },
      {
        id: "fs9",
        topic: "Web Security",
        question: "Which header helps prevent cross-site scripting by restricting sources?",
        options: ["Cache-Control", "Content-Security-Policy", "ETag", "Accept-Encoding"],
        answer: 1,
      },
      {
        id: "fs10",
        topic: "Git & CI",
        question: "What is the main purpose of a pull request check pipeline?",
        options: [
          "Deploy to production",
          "Validate the change before merge",
          "Squash commits",
          "Tag releases",
        ],
        answer: 1,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "ai4",
        topic: "Model Evaluation",
        question: "Which metric is most useful for a highly imbalanced classification problem?",
      ...
      },
      {
        id: "ai5",
        topic: "Training",
        question: "What does a learning rate that is far too high usually cause?",
        options: [
          "Very slow but stable training",
          "Diverging or oscillating loss",
      ...
      },
      {
        id: "ai6",
        topic: "Data Handling",
        question: "Why should scaling be fit on the training split only?",
        options: [
          "It runs faster",
          "To avoid leaking test statistics into training",
          "Scaling needs sorted data",
      ...
      },
      {
        ...
        options: ["Speeding up inference", "Regularization", "Data loading", "Gradient clipping"],
        answer: 1,
      },
      {
        id: "ai8",
      ...
      },
      {
        id: "ai9",
        topic: "MLOps",
        question: "Why serve a model behind an API instead of a notebook?",
        options: [
          "Notebooks are faster",
          "APIs give a reproducible, scalable interface for apps",
          "APIs train models",
      ...
      },
      {
        id: "ai10",
        topic: "SQL",
        question: "Which clause would you use to fetch only the top 10 rows by score?",
        options: [
          "GROUP BY score",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          "It runs multiple containers",
          "It keeps build tools out of the final image",
          "It enables GPU access",
          "It replaces compose",
        ],
        answer: 1,
      },
      ...
      },
      {
        ...
        options: [
          "Application logs",
          "The mapping of config to real infrastructure",
          "Container memory",
          "User sessions",
        ],
        answer: 1,
      },
      {
        id: "cl7",
        topic: "Observability",
        question: "Which signal best answers 'how long did this request take'?",
        options: ["Logs only", "Traces and latency metrics", "Config files", "IAM policies"],
        answer: 1,
      },
      {
        id: "cl8",
        topic: "Networking",
        question: "What does a load balancer primarily do?",
        options: [
          "Encrypt databases",
      ...
      },
      {
        id: "cl10",
        topic: "SQL Indexing",
        question: "What is a common downside of adding many indexes?",
        options: [
          "Slower reads",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "da4",
        topic: "SQL Indexing",
        question: "An index on a column mainly improves which operation?",
        options: ["Inserts", "Filtered lookups and sorts", "Backups", "Permissions"],
        answer: 1,
      },
      {
        id: "da5",
        topic: "SQL",
        question: "What does a window function let you do that GROUP BY does not?",
        options: [
          "Filter rows",
          "Keep row detail while computing aggregates",
          "Create tables",
          "Delete duplicates",
        ],
        answer: 1,
      },
      {
        id: "da6",
        topic: "Python",
        question: "Which pandas method combines two DataFrames on a key column?",
        options: ["concat()", "merge()", "melt()", "pivot()"],
        answer: 1,
      },
      {
        id: "da7",
      ...
      },
      {
        ...
        question: "In a star schema, the central table holds:",
        options: ["Dimensions", "Facts / measures", "Indexes", "Users"],
        answer: 1,
      },
      {
        id: "da9",
        topic: "Visualization",
        question: "Which chart best shows a part-to-whole change over time?",
        options: ["Scatter plot", "Stacked area chart", "Box plot", "Histogram"],
        answer: 1,
      },
      {
        id: "da10",
        topic: "REST APIs",
        question: "What format do most analytics APIs return data in?",
        options: ["XML only", "JSON", "CSV only", "Binary blobs"],
        answer: 1,
      },
    ],
    mastered: [
