...
const INITIAL_CURRICULUM: WeekCurriculum[] = [
  {
    ...
    modules: [
      { id: "w1-m1", title: "System Architecture & Design Principles", type: "video", duration: "20 mins", completed: false, content: "Module 1 Matter: Master scalable system design, monolithic vs microservices trade-offs, high availability patterns, load balancers, and fault-tolerance mechanisms for enterprise applications." },
      { id: "w1-m2", title: "Reading: Clean Code & Best Practices", type: "reading", duration: "20 mins", completed: false, content: "Module 2 Matter: Learn SOLID principles, effective function naming, proper error handling, DRY/KISS design patterns, and robust code maintainability standards." },
      { id: "w1-m3", title: "Week 1 Knowledge Check (Quiz)", type: "quiz", duration: "20 mins", completed: false, content: "Module 3 Matter: Evaluate foundational concepts of memory heaps/stacks, HTTP request protocols, status codes, and clean architectural design patterns." },
    ],
  },
  {
    week: 2,
    ...
    modules: [
      { id: "w2-m1", title: "Optimizing Search & Graph Traversals", type: "video", duration: "20 mins", completed: false, content: "Module 4 Matter: Deep dive into BFS/DFS tree traversals, Dijkstra's shortest path, A* heuristic search, and efficient memoization strategies." },
      { id: "w2-m2", title: "Practical Coding Assignment", type: "assignment", duration: "20 mins", completed: false, content: "Module 5 Matter: Implement high-performance hash maps, handle collision resolution, and optimize runtime complexity down to O(N)." },
      { id: "w2-m3", title: "Algorithmic Complexity Assessment", type: "quiz", duration: "20 mins", completed: false, content: "Module 6 Matter: Test your ability to analyze Big-O space and time bottlenecks across complex recursive data processing pipelines." },
    ],
  },
  {
    week: 3,
    ...
    modules: [
      { id: "w3-m1", title: "Microservices & Load Balancing", type: "video", duration: "20 mins", completed: false, content: "Module 7 Matter: Explore NGINX round-robin routing, AWS Application Load Balancers, circuit breakers, and distributed service mesh topologies." },
      { id: "w3-m2", title: "Case Study: Scaling to 10M Users", type: "reading", duration: "20 mins", completed: false, content: "Module 8 Matter: Analyze real-world database sharding strategies, read-replicas, write-ahead logging, and Redis distributed caching layers." },
      { id: "w3-m3", title: "Cloud Deployment Verification Task", type: "assignment", duration: "20 mins", completed: false, content: "Module 9 Matter: Configure containerized Docker services, write Kubernetes manifests, and manage automated CI/CD deployment scripts." },
    ],
  },
  {
    week: 4,
    ...
    modules: [
      { id: "w4-m1", title: "Building Production-Ready Endpoints", type: "video", duration: "20 mins", completed: false, content: "Module 10 Matter: Implement rate limiting, JWT bearer token verification, input sanitization, and structured request logging." },
      { id: "w4-m2", title: "Final Capstone Implementation", type: "assignment", duration: "20 mins", completed: false, content: "Module 11 Matter: Construct an end-to-end distributed backend application meeting enterprise scalability and security criteria." },
      { id: "w4-m3", title: "Final Comprehensive Course Defense", type: "quiz", duration: "20 mins", completed: false, content: "Module 12 Matter: Defend architectural trade-offs in a simulated technical review board examination before unlocking placements." },
    ],
  },
];
...
function StudentAssessmentEngine() {
  ...
  const [moduleTimer, setModuleTimer] = useState(1200);
          ...
          <div className="p-6 rounded-2xl border border-blue-500/30 bg-gradient-to-r from-blue-950/60 to-slate-900 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="space-y-1 text-center sm:text-left">
              ...
              <p className="text-xs text-slate-300">
                {completedModulesCount} of {totalModules} modules studied & completed ({Math.round((completedModulesCount / totalModules) * 100)}%)
              </p>
            </div>
                    ...
                    <div className="space-y-3">
                      {weekData.modules.map((mod) => (
                        ...
                        >
                          ...
                          >
                            {mod.completed ? "Review Study" : "Open & Study"}
                          </Button>
                        </div>
                      ))}
                    </div>
        ...
        <div className="w-full max-w-5xl mx-auto space-y-6">
          <div className="p-6 rounded-2xl border border-emerald-500/30 bg-slate-900/90 shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">Unlocked after successfully studying and completing all required weekly course modules.</p>
            </div>
            <div className="flex gap-2">
